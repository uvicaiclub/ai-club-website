  ...
  return (
    <div>
      <div className="pt-2">
        ...
        <div className="h3 pt-2">Club Days - May 31st</div>
        <p>
          Check us out at UVic's ternary Club Days. We'll be showcasing our
          work, engaging with the community, and we hope to see you there!
        </p>
        <div className="h3 pt-2">Club Hackathon - June 18th</div>
        <p>
